...
public class Table extends  Database{
    public String ID="", Code="", Name="", Remark="", Active="", Sort1="", AreaID="", StatusUse="", DateUse="";
    public String dbID="table_id", dbCode="table_code", dbName="table_name", dbRemark="remark", dbActive="active", dbSort1="sort1", dbAreaID="area_id", dbStatusUse="status_use", dbDateUse="date_use";
